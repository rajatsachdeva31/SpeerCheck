...
import { findOverlappingSlots, isSlotInAvailabilityRanges, isSlotScheduled } from "@/lib/availability-utils"
...
describe("Availability Utilities", () => {
  describe("isSlotInAvailabilityRanges", () => {
    it("should return true when a time slot is within an availability range", () => {
      ...
      const ranges: AvailabilityRange[] = [{ day: "monday", startTime: "9:00", endTime: "12:00" }]
  ...
  describe("isSlotScheduled", () => {
    it("should return true when a slot is already scheduled for an engineer", () => {
      ...
      const scheduledInterviews = [
        { candidateId: "cand1", engineerId: "eng1", timeSlot: { day: "monday", time: "10:30" } },
      ]
    ...
    it("should return false when a slot is not scheduled for an engineer", () => {
      ...
      const engineerId = "eng1"
      const scheduledInterviews = [
        { candidateId: "cand1", engineerId: "eng2", timeSlot: { day: "monday", time: "10:30" } },
        { candidateId: "cand2", engineerId: "eng1", timeSlot: { day: "tuesday", time: "10:30" } },
      ]

      expect(isSlotScheduled(slot, engineerId, scheduledInterviews)).toBe(false)
    })
  })

  describe("findOverlappingSlots", () => {
    it("should find slots where candidate and at least one engineer are available", () => {
      const candidateAvailability: AvailabilityRange[] = [{ day: "monday", startTime: "10:00", endTime: "12:00" }]
      ...
      const result = findOverlappingSlots(candidateAvailability, engineersAvailability, scheduledInterviews)
      ...
      const scheduledInterviews = [
        {
          candidateId: "cand1",
          engineerId: "eng1",
          timeSlot: { day: "monday", time: "10:00" },
        },
      ]
